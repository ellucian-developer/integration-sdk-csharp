...
namespace Ellucian.Ethos.Integration.Notification
{
    ...
    /// of persons v12.
    /// </summary>
    public class EthosChangeNotificationPollService : AbstractEthosNotificationPollService
    {
        /// <summary>
        /// <see cref="EthosChangeNotificationSubscription"/> used by client application.
        /// </summary>
        public AbstractEthosNotificationSubscription<ChangeNotification> Subscription { get; }
        ...
        public EthosChangeNotificationPollService( EthosChangeNotificationService cnService, int? limit, int? pollingInterval )
        {
            if ( cnService == null )
            {
            ...
            Limit = limit;
            Subscription = new EthosChangeNotificationSubscription( cnService ) { PollingInterval = pollingInterval ?? 60 };
        }
        ...
        /// <returns></returns>
        public EthosChangeNotificationPollService AddSubscriber( AbstractEthosChangeNotificationSubscriber<ChangeNotification> subscriber )
        {
        ...
        public void Unsubscribe( AbstractEthosChangeNotificationSubscriber<ChangeNotification> subscriber )
        {
