...
namespace Ellucian.Ethos.Integration.Client.Proxy
{
    ...
    /// </summary>
    public class ColleagueWebApiFilterQueryClient : EthosProxyClient
    {
        ...
        public ColleagueWebApiFilterQueryClient( string apiKey, HttpClient client ) : base( apiKey, client )
        {
